  ...
  module Frete
    class Servico
      ...
      AVAILABLE_SERVICES = {
        ...
        "04162" => { :type => :sedex_ecommerce,             :name => "SEDEX Ecommerce", :description => "Sedex ecommerce com contrato"      },
        "04669" => { :type => :pac_ecommerce,               :name => "PAC Ecommerce",   :description => "Pac ecommerce com contrato"        },
